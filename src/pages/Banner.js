...
function Banner() {
  return (
    <div className="relative w-full justify-center items-center mt-10 md:mt-12">
      <Swiper modules={[Autoplay, EffectFade]} effect="fade" autoplay={{ delay: 4000 }} loop className="h-[95vh] z-0  ">
        <SwiperSlide>
      ...
      <div className="absolute flex justify-center inset-0 z-100 lg:pl-7 flex flex-col gap-1 lg:space-y-5">
        ...
        <p className="text-left text-xs md:text-xs lg:text-sm text-white max-w-sm text-gray-500 drop-shadow-2xl md:mt-2 ">
