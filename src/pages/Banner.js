      ...
      <div className="absolute justify-center items-center inset-0 z-100 p-4 lg:pl-7 flex flex-col gap-1 lg:space-y-5">
        ...
        <div className="flex justify-center gap-2 py-2 md:mt-2 w-100 w-10 md:w-50">
          <Nav.Link
            as={NavLink}
            to="/products"
            className="flex items-center justify-center text-white text-sm lg:text-lg w-1/2 md:w-2/5 lg:w-1/5 py-1 md:py-6 md:h-[8vh] lg:h-[8vh] border rounded-full  hover:bg-black hover:text-white text-center font-semibold text-gray-900 transition duration-100"
          >
            DISCOVER{" "}
            <span>
