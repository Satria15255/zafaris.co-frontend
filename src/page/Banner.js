...
function Banner() {
  return (
    <div className="flex justify-center items-center md:mt-2 lg:h-screen">
            ...
            <div className="p-2">
              ...
              <div className="flex flex-col md:flex-row gap-2 py-2 md:mt-2 lg:mt-4 w-100 w-10 md:w-50">
                <Nav.Link
                  as={NavLink}
                  to="/products"
                  className="flex items-center justify-center text-[6px] md:text-lg lg:text-lg w-2/5 md:w-1/2 py-1 md:py-6 lg:h-[10vh] border border-black hover:border-yellow-500   hover:bg-yellow-500 text-center bg-gray-900 text-white transition duration-100"
                >
                  Discover
                </Nav.Link>
              </div>
