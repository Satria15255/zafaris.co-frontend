        ...
        <div className=" flex  h-[40vh] md:h-[65vh] lg:h-[85vh] z-0 rounded-3xl md:rounded-5 lg:rounded-3xl bg-center bg-cover" style={{ backgroundImage: `url(${Slide2})` }}>
          <div className="grid grid-cols-1 md:grid-cols-2 items-center w-100 h-full rounded-3xl ">
            <div className="p-3 flex flex-col gap-1 lg:space-y-5">
              <h2 className="text-left text-[19px] md:text-4xl lg:text-6xl drop-shadow-2xl font-bold flex flex-col">
                Walk in Comfort <span>Step in Style.</span>
              </h2>
              <p className="text-left text-[7px] md:text-xs lg:text-sm text-gray-500 drop-shadow-2xl md:mt-2 ">
              ...
              <div className="flex gap-2 py-2 md:mt-2 w-100 w-10 md:w-50">
                <Nav.Link
                  as={NavLink}
                  to="/products"
                  className="flex items-center justify-center text-[7px] md:text-sm lg:text-lg w-2/5 md:w-2/5 py-1 md:py-6 md:h-[8vh] lg:h-[8vh] border border-black rounded-full  hover:bg-white hover:text-black text-center bg-gray-900 text-gray-100 transition duration-100"
                >
                  Discover
                </Nav.Link>
              </div>
