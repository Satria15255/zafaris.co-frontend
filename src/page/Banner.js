            ...
            <div className="p-3 flex flex-col gap-1 lg:space-y-5">
              ...
              <div className="flex gap-2 py-2 md:mt-2 w-100 w-10 md:w-50">
                <Nav.Link
                  as={NavLink}
                  to="/products"
                  className="flex items-center justify-center text-sm md:text-sm lg:text-lg w-1/2 md:w-2/5 py-1 md:py-6 md:h-[8vh] lg:h-[8vh] border border-black rounded-full  hover:bg-white hover:text-black text-center bg-gray-900 text-gray-100 transition duration-100"
                >
                  Discover
                </Nav.Link>
              </div>
